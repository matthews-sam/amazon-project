/**
 * products.js — Product catalog data layer
 */

/**
 * FIX: Original used forEach to scan for a match; replaced with
 * Array.find() which is semantically correct and short-circuits on first hit.
 * FIX: Now returns null (not undefined) when product is not found,
 * so callers can do a clear null-check instead of a falsy check.
 */
